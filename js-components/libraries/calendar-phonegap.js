...
// Sean Bedford
// 
cordova.define("cordova/plugin/calendarPlugin", function(require, exports, module) {
  function calendarPlugin()
  {
  }

  calendarPlugin.prototype.createEvent = function(title,location,notes,startDate,endDate,alarm,successCallback, errorCallback) {
  ...
  var calendar = new calendarPlugin();
